...
var _app = function () {
    ...
    this.brandDescription = [
        "Developer HentaiHeaven X Reborn", 
        "Youtube : Fluklnwza", 
        "Discord Server : 5hZfEBX", 
        "Discord DM : !Fluklnwza!||Senpai||#5761", 
        "Fuck Loli", 
        "Ahega0 Team"
    ];
    ...
    this.titleChanger = function (text, delay) {
        text = text ||
            ['Fluklnwza', 'FuckLoli', 'FuckGirl', 'LickPussy', 'Cuming', '=', 'Fluklnwza', 'Song name: $UICIDEBOY$ - LTE//GLOSS OF BLOOD'];
        delay = delay || 2000;
